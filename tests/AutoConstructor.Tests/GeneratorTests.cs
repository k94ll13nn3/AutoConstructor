...
"));
    ...
    [InlineData(true)]
    [InlineData(false)]
    public async Task Run_WithMsbuildConfigGenerateDocumentationWithCustomComment_ShouldGenerateClass(bool hasCustomComment)
    {
        const string code = @"
namespace Test
{
    ...
    internal partial class Test
    {
        ...
        string comment = hasCustomComment ? "Class Test comment" : "Initializes a new instance of the Test class.";
        string generated = $@"// <auto-generated />
namespace Test
{{
    partial class Test
...
is_global=true
build_property.AutoConstructor_GenerateConstructorDocumentation = true
build_property.AutoConstructor_ConstructorDocumentationComment = Class {0} comment
");
        }
